...
var $author$project$Main$targetInnerHtml = A2(
	$elm$json$Json$Decode$at,
	_List_fromArray(
		['target', 'innerHTML']),
	$elm$json$Json$Decode$string);
var $author$project$Main$onContent = function (tagger) {
	return A2(
		$elm$html$Html$Events$on,
		'input',
		A2($elm$json$Json$Decode$map, tagger, $author$project$Main$targetInnerHtml));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$onContent($author$project$Main$EditorChanged)
					]),
				_List_Nil)
			]),
		title: 'T&T'
